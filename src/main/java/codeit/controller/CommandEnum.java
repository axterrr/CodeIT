...
public enum CommandEnum {
    ...
    GET_UPDATE_CLIENT ("GET:/client/update", new GetUpdateClientCommand()),
    POST_UPDATE_CLIENT ("GET:/client/update", new PostUpdateClientCommand()),
    DELETE_CLIENT ("GET:/client/delete", new DeleteClientCommand()),
